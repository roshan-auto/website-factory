...
import {
  ...
  CheckCircle2, Star, Droplets, Wrench, ShieldCheck,
  Building2, ChevronRight, Menu, X, Calendar,
  MessageSquare, Bot, Award, ThumbsUp, Users, Thermometer, Settings,
} from 'lucide-react';
...
function PortfolioBar() {
  return (
    <div className="bg-slate-950 border-b border-white/[0.06] px-5 py-2 flex items-center justify-between sticky top-0 z-50">
      ...
      <Link href="/" className="flex items-center gap-1.5 text-[11px] text-white/35 hover:text-white/70 transition-colors">
