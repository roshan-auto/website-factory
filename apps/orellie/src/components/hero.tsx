    ...
    <section className="relative flex items-center bg-background overflow-hidden py-16 lg:py-24">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center z-10">
        ...
        <motion.div
          ...
          animate="visible"
        >
          <motion.div variants={itemVariants} className="mb-4 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5 text-sm text-primary tracking-wide font-medium shadow-sm">
